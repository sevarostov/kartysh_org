        ...
        <?php else: ?>
            ...
            <div class="login-form">
                <form action="#" method="post">
                    ...
                    <hr>
                    <p>Номер телефона</p>
                    <input type="text" name="userPhone" placeholder="№ Телефона" value="<?php echo $userPhone; ?>"/>
                    <hr>
                    <p>Email</p>
                ...
                <div class="card">
                    ...
                    <form class="card-body">
                        ...
                        <div class="md-form mb-5">
                            <input type="text" id="email" class="form-control" placeholder="petrov@mail.ru"
                        ...
                        <div class="md-form mb-5">
                            <input type="text" id="address" class="form-control"
                                   placeholder="город, улица, дом, № квартиры">
                            <label for="address" class="">адрес</label>
                        </div>

                        <!--address-2-->
                        <div class="md-form mb-5">
                            <input type="text" class="form-control" name="userComment" placeholder="cообщение"
                        ...
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="same-address">Адрес доставки совпадает с указанным
                                почтовым адресом</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" id="save-info">
                            <label class="custom-control-label" for="save-info">Сохранить информацию для последующих
                                заказов</label>
                        </div>
                        ...
                        <hr class="mb-4">
                        <button class="btn btn-primary btn-lg btn-block" type="submit" name="submit">Продолжить
                            оформление заказа
                        </button>
