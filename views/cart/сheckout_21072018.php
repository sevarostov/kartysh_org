                        ...
                        <div class="col-md-8 mb-4">
                            ...
                            <div class="card">
                                ...
                                <form class="card-body">
                                    ...
                                    <!--address-2-->
                                    <div class="md-form mb-5">
                                        <input type="text" class="form-control" name="userComment"
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        ...
                                        <label class="custom-control-label" for="same-address">Адрес доставки совпадает
                                            с указанным
                                            почтовым адресом</label>
                                    </div>
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="save-info">
                                        <label class="custom-control-label" for="save-info">Сохранить информацию для
                                            последующих
                                            заказов</label>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <small class="text-muted">Пожалуйста введите полное имя как указано на
                                                карте
                                            </small>
                                            <div class="invalid-feedback">
