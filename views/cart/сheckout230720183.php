            ...
            <div class="col-md-8 mb-4">
                ...
                <div class="card">
                    ...
                    <form class="card-body">
                        ...
                        <!--address-->
                        <div class="md-form mb-5">
                            <input type="text" name="userAddress" id="userAddress" class="form-control" placeholder="  111111 город, улица, дом, № квартиры" value="<?php echo $userAddress; ?>">
            ...
            <div class="col-md-4 mb-4">
                ...
                <ul class="list-group mb-3 z-depth-1">
                    ...
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        <div>
                            <h6 class="my-0"><a href="/product/view/<?php echo $product['id'];?>">
