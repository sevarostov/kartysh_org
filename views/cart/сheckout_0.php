                ...
                <div class="card">
                    ...
                    <form class="card-body">
                        ...
                        <div class="md-form mb-5">
                            <input type="text" id="email" class="form-control" placeholder="petrov@mail.ru" value="<?php echo $userEmail; ?>"/>
                            <label for="email" class="">Email </label>
                        </div>

                        <!--address-->
                        <div class="md-form mb-5">
                            <input type="text" id="address" class="form-control" placeholder="город, улица, дом, № квартиры">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 mb-4">
                                ...
                                <input type="text" class="form-control" id="zip" placeholder="344000" required>
                                <div class="invalid-feedback">
