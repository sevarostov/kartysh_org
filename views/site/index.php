                ...
                <div class="view"
                    ...
                    <div class="mask rgba-blue-light d-flex justify-content-center align-items-center">
                        ...
                        <div class="text-center white-text mx-5 wow fadeIn">
                            ...
                            <a href="/all/" class="btn btn-outline-white btn-lg">Подробнее
                    ...
                    <div class="mask rgba-blue-light d-flex justify-content-center align-items-center">
                        ...
                        <div class="text-center white-text mx-5 wow fadeIn">
                            ...
                            <h2 class="mb-4 d-none d-md-block">
                                <strong>Качество на высоте</strong>
                            </h2>

                            <a href="/category/view/1/" class="btn btn-outline-white btn-lg">Подробнее
                                <i class="fa fa-folder-open ml-2"></i>
                            </a>
                        </div>
                        <!-- Content -->
                ...
                <div class="view"
                    ...
                    <div class="mask rgba-blue-light d-flex justify-content-center align-items-center">
                        ...
                        <div class="text-center white-text mx-5 wow fadeIn">
                            ...
                            <p>
                                <strong>Удивительные подарки</strong>
                            </p>
                            ...
                            <a href="/category/view/2/" class="btn btn-outline-white btn-lg">Подробнее
                                <i class="fa fa-folder-open ml-2"></i>
                            </a>
                        </div>
                        <!-- Content -->
