...
class Order
{
     ...
     */
    public static function save($userName, $userSurname, $userPhone, $userEmail, $userAddress, $userComment, $userId, $products)
    {
         $products = json_encode($products);
        $db = Db::getConnection();
        $date = date("Y-m-d H:i:s");

        $sql = 'INSERT INTO product_order (user_name, user_surname, user_phone, user_email, user_address, user_comment, user_id, products, date) '
            . 'VALUES (:user_name, :user_surname, :user_phone, :user_email, :user_address, :user_comment, :user_id, :products, :date)';
    ...
    public static function createNewUser($userName, $userEmail)
    {

        $db = Db::getConnection();
        $sql = 'INSERT INTO public.user (id, name, email)
